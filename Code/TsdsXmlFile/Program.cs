...
namespace TsdsXmlFile
{
    class Program
    {
        private static string ServiceKey
        {
            get
            {
                return "CLI_Txkea_TsdsXmlFile_Service";  //David 08262016 THe ServiceKey MUST start with 'CLI'
            }
        }
        ...
        private static string ServiceName
        {
            get
            {
                return "CLI_Txkea_TsdsXmlFile_Service"; //David 08262016 THe ServiceName MUST start with 'CLI'
            }
        }
        ...
        private static string ServiceDescription
        {
            get
            {
                return "Txkea Tsds Xml file service for generate student-assessment xml file.";
            }
        }
