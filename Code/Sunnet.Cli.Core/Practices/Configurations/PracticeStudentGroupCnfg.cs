...
{
    internal class PracticeStudentGroupCnfg : EntityTypeConfiguration<PracticeStudentGroupEntity>, IEntityMapper
    {
        public PracticeStudentGroupCnfg()
        {
            ToTable("PracticeStudentGroups");
        }
