...
{
    public class PracticeStudentItemEntity : EntityBase<int>
    {
        public PracticeStudentItemEntity()
        {
        ...
        public virtual PracticeStudentMeasureEntity Measure { get; set; }

        public virtual CliAdeItemBaseEntity Item { get; set; }
    }
}
