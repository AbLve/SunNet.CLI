...
{
    internal class StudentAssessmentCnfg : EntityTypeConfiguration<StudentAssessmentEntity>, IEntityMapper
    {
        public StudentAssessmentCnfg()
        {
            ToTable("StudentAssessments");
