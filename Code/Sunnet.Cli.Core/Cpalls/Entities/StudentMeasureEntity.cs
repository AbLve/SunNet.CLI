...
{
    public class StudentMeasureEntity : EntityBase<int>
    {
        ...
        public virtual ICollection<StudentItemEntity> Items { get; set; }

        public virtual StudentAssessmentEntity Assessment { get; set; }
