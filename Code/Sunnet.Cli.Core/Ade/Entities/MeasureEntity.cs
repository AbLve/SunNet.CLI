...
{
    public class MeasureEntity : EntityBase<int>, IAdeLinkProperties, ICutOffScoreProperties
    {
        ...
        public virtual MeasureEntity Parent { get; set; }
        public virtual ICollection<MeasureEntity> SubMeasures { get; set; }

        public virtual ICollection<ItemBaseEntity> Items { get; set; }
