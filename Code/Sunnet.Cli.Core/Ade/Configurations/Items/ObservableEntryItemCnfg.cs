...
{
	internal class ObservableEntryItemCnfg : EntityTypeConfiguration<ObservableEntryEntity>, IEntityMapper
    {
        public ObservableEntryItemCnfg()
	    {
            ToTable("ObservableEntryItems");
	    }
