...
(function (factory) {
    ...
    */
    ...
    $.validator.addMethod("uint", function (value, element) {
        return this.optional(element) || /^\d+$/.test(value);
    ...
    $.validator.addMethod("minDate", function (value, element, minDate) {
        ...
        return this.optional(element) || (isDate(targetDate.toString()) && targetDate >= minDt);
    }, "Entered Date of Birth is out of range.");

    $.validator.addMethod("maxDate", function (value, element, maxDate)
    {
        var targetDate = new Date(value);
        var maxDt = new Date(maxDate);
        return this.optional(element) || (isDate(targetDate.toString()) && targetDate <= maxDt);
    }, "Entered Date of Birth is out of range.");
