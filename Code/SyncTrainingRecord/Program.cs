...
namespace SyncTrainingRecord
{
    class Program
    {
        private static string ServiceKey
        {
            get
            {
                return "SyncTrainingRecord_Service";
            }
        }
        ...
        private static string ServiceName
        {
            get
            {
                return "SyncTrainingRecordt_Service";
            }
        }
        ...
        private static string ServiceDescription
        {
            get
            {
                return "Sync LMS Course Certificate to TECPDS TrainingAttends table. --09/13/2017";
            }
        }
        ...
        static void Main(string[] args)
        {
            ...
            if (runningMode == "Debug")//Debug Mode
            {
                ...
                Config.Instance.Logger.Info("Running with Windows debug/Task Schedule mode...");
                Test();
            }
