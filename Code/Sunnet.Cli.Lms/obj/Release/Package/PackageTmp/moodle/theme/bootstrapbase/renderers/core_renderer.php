...
class theme_bootstrapbase_core_renderer extends core_renderer {
    ...
    protected function render_custom_menu(custom_menu $menu) {
        ...
        $content.='<li style="padding-left:36px;"><a class="active" href="'.$CFG->cli.'/">Home</a></li>
                <li style="padding-left:12px;"><a class="" href="'.$CFG->cli.'/about">About Us</a></li>
                <li style="padding-left:12px;"><a class="" href="'.$CFG->cli.'/demo">Engage Demos</a></li>
                <li style="padding-left:12px;"><a class="" href="'.$CFG->cli.'/faq">FAQ</a></li>
                <li style="padding-left:12px;"><a class="" href="'.$CFG->cli.'/contact">Contact Us</a></li>';
