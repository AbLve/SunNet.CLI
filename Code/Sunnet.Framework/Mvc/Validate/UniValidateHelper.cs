...
namespace Sunnet.Framework.Mvc.Validate
{
    public class UniValidateHelper
    {
        ...
        public MvcHtmlString ValidEnd()
        {
            if (_js == null)
            {
                ...
                _js = "$(function(){"
                    ...
                    + (ShowErrorBy == null ? showErrorsHide() : showErrorsToOne(ShowErrorTo))
                    + (ShowErrorTo == null ? ", errorLabelContainer: \"#" + FormID + " .error_panel\"" : ", errorLabelContainer: \"" + ShowErrorTo + "\"")
                    + ""
                    + "\r\n"
                    + "}; \r\n"
        ...
        public string ShowErrorBy { get; set; }
        #endregion
    }
}
