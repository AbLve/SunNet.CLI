...
namespace Sunnet.Framework.Core.Extensions
{
    ...
    public static class CollectionsExtensions
    {
        ...
        /// <typeparam name="T">动态类型</typeparam>
        /// <returns>排序后的数据集</returns>
        public static IOrderedQueryable<T> OrderBy<T>(this IQueryable<T> source, string propertyName, string orderDirection)
        {
            PublicHelper.CheckArgument(propertyName, "propertyName");
            var sortDirection = orderDirection.Equals("asc", StringComparison.CurrentCultureIgnoreCase)
        ...
        private static class QueryableHelper<T>
        {
            ...
            private static LambdaExpression GetLambdaExpression(string propertyName)
            {
                ...
                MemberExpression body = PropertyOfProperty(param, propertyName);
