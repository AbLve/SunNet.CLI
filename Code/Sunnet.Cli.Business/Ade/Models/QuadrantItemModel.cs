 ...
 * Computer:		JACKZ
 * Domain:			Jackz
 * CreatedOn:		2014/8/28 20:23:09
 * Description:		Please input class summary
 * Version History:	Created,2014/8/28 20:23:09
 * 
 * 
 **************************************************************************/
...
{
    public class QuadrantItemModel:ItemModelBase<QuadrantItemEntity>
    {
        public override ItemType Type
        {
            get
            {
                return ItemType.Quadrant;
            }
            set { }
        }
        ...
        public QuadrantItemModel()
        {
        }

        public QuadrantItemModel(QuadrantItemEntity entity) : base(entity)
        {
        ...
        public override void UpdateEntity(QuadrantItemEntity entity)
        {
