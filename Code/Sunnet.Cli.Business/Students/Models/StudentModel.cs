...
namespace Sunnet.Cli.Business.Students.Models
{
    public class StudentModel
    {
        ...
        [JsonIgnore]
        public IEnumerable<int> SchoolIdList { get; set; }

        [JsonIgnore]
        public IEnumerable<string> SchoolNameList { get; set; }
        ...
        public string SchoolName
        {
            get
            {
                if (SchoolNameList == null) return string.Empty;
                return string.Join(", ", SchoolNameList);
            }
        }
        ...
        //[Required]
        //[DisplayName("Assign Student to Class")]
        ...
        public List<ObservableReportModel> Reports { get; set; }

    }



    public class StudentModelForQueue
    {
        public int ID { get; set; }
        public string SchoolYear { get; set; }
